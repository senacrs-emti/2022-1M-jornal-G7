   <?php
    ...
    <main class="row">
        ...
        <div class="col-10 ">
            ...
            <hr>
            <img class="img_N" src="..." class="w-100" alt="...">
            ...
            <img class="img_N" src="https://st.depositphotos.com/1010338/2099/i/450/depositphotos_20999947-stock-photo-tropical-island-with-palms.jpg" class="img-fluid" alt="...">

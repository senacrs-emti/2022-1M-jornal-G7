...
<html lang="en">
  <head>
    ...
    <!--nosso css-->
    <link rel="stylesheet" href="./noticias_layout/noticias.css">
  </head>
  <body>
    <?php
    ...
    <main>
        <div>
            ...
            <h5 class="text-center">Data:27/07/2006<h5>
        </div>
    <hr>

    <article id="container-article">
            <img src="https://www.tbsconsultoria.com.br/wp-content/uploads/2019/01/265919-redator-entregar-ate-2812-as-10heconomia-mundial-quais-sao-as-10-tendencias-para-os-proximos-anos.jpg" class="img-fluid" alt="...">
            <img src="https://www.blbbrasil.com.br/blog/wp-content/uploads/2020/10/blb-ventures-nova-economia.png" class="rounded float-end" alt="...">
